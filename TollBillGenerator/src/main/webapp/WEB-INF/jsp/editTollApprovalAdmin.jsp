				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form:form class="border border-light pt-1 pb-3 px-5"
							modelAttribute="etollDetails" action="/updateTollDetailsAdmin"
							method="POST">
							...
							<!-- Approval  -->
							<div class="mb-4 ">
								<label for="tapproval" class="form-label">Approval
									Status</label>

								<form:select path="tapproval" name="tapproval"
									class="form-control">
