					...
					<div class="card-body">
						...
						<div class="mx-5">
							...
							<c:if test="${not empty regMsg}">
								<div class="alert alert-success text-center" role="alert">
									<strong><c:out value="${regMsg}" /></strong>
								</div>
								<c:set var="regMsg" value="" scope="session" />
							</c:if>
						...
						<form class="border border-light pt-1 pb-3 px-5"
							...
							<div class="text-center">
								<p>
									Not registered? <a href="/regUser">Register</a>
								</p>

								<p>or login in as :</p>
								<a type="button" class="btn btn-block btn-primary my-3"
									href="/manager">Manager</a> <a type="button"
									class="btn btn-block btn-primary mb-4" href="/admin">Admin</a>
							</div>
						</form>
					</div>
